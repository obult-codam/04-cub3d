...
/*   Updated: 2022/10/01 19:24:50 by oswin         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
double	max_x_dist(t_data data, double angle, double x, double y)
{
	...
	if ((int)round(x_dist + x) > data.x_max || (int)round(x_dist + x) < 0)
		return (ERROR);
...
int	main(void)
{
	...
	printf("this is incorrect because it now runs twice as far\n");
